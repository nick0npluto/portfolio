...
export const MOODS: Record<Mood, MoodConfig> = {
  hire: {
    ...
    sub:       'Python · TypeScript · React · AWS · Data Engineering — one engineer who covers the whole stack.',
    ctaLabel:  'Get in touch',
    emphasis:  'skills',
    bio:       'CS grad from Georgia State (3.5 GPA, Dec 2025) with real production experience: built AWS data pipelines at Carter\'s cutting vendor processing from 30 days to under 24 hours, automated payroll systems saving 90% processing time, and shipped a full-stack booking platform from scratch. I write clean code, move fast, and care about the outcome — not just the ticket.',
  },
  collaborate: {
    label:     'Collaborate',
    accent:    '#FF8C42',
    ...
    sub:       'From rough requirements to a working product — let\'s build something that actually works.',
    ctaLabel:  'Share your idea',
    emphasis:  'process',
    bio:       'I\'m most useful when there\'s a real problem to solve. Give me ambiguous requirements and I\'ll figure it out — I\'ve built booking platforms, payroll automation, and AWS pipelines, usually with whatever the situation calls for. I work well with founders, small teams, and anyone who needs a technical partner who can see the full picture.',
  },
  curious: {
    label:     'Just Curious',
    accent:    '#A78BFA',
    ...
    sub:       'CS grad. Founder. Engineer. Explore the work.',
    ctaLabel:  'Say hello',
    emphasis:  'story',
    bio:       'I graduated from Georgia State in December 2025, but I didn\'t wait to start shipping. While in school I interned at Carter\'s, founded a detailing business with a full booking platform, and built payroll automation for a parking operator. I build things that solve real problems — poke around and see.',
  },
}
